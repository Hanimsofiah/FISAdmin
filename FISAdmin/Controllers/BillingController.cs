        ...
        public IActionResult Create(BillingPaymentModel obj, string type, string shortform)
        {
            switch (shortform)
            {
                case "BCB":
                    ...
                    sql2 = "INSERT INTO billing_category_bill (id,description) VALUES (@id,@description)";
                    break;
                case "BCC":
                    ...
                    sql2 = "INSERT INTO billing_customer_category (id,description) VALUES (@id,@description)";
                    break;
                case "BDT":
                    ...
                    sql2 = "INSERT INTO billing_doc_type (id,description) VALUES (@id,@description)";
                    break;
                case "BFD":
                    ...
                    sql2 = "INSERT INTO billing_fis_destination(id,description) VALUES (@id,@description)";
                    break;
                case "BP":
                    ...
                    sql2 = "INSERT INTO billing_priority (id,description) VALUES (@id,@description)";
                    break;
                case "BSCB":
                    ...
                    sql2 = "INSERT INTO billing_source_bill (id,description) VALUES (@id,@description)";
                    break;
                case "BSTB":
                    ...
                    sql2 = "INSERT INTO billing_status_bill (id,description) VALUES (@id,@description)";
                    break;
                default:
                    break;
            }
        ...
        public IActionResult Edit(string id, string type, string shortform)
        {
            switch (shortform)
            {
                case "BCB":
                    ...
                    sql = "SELECT id,description FROM billing_category_bill WHERE id=@id";
                    break;
                case "BCC":
        ...
        public IActionResult Edit(string type, string shortform)
        {
            switch (shortform)
            {
                case "BCB":
                    ...
                    sql = "UPDATE billing_category_bill SET description=@description WHERE id=@id";
                    break;
                case "BCC":
                    ...
                    sql = "UPDATE billing_customer_category SET description=@description WHERE id=@id";
                    break;
                case "BDT":
                    ...
                    sql = "UPDATE billing_doc_type SET description=@description WHERE id=@id";
                    break;
                case "BFD":
                    ...
                    sql = "UPDATE billing_fis_destination SET description=@description WHERE id=@id";
                    break;
                case "BP":
                    ...
                    sql = "UPDATE billing_priority SET description=@description WHERE id=@id";
                    break;
                case "BSCB":
                    ...
                    sql = "UPDATE billing_source_bill SET description=@description WHERE id=@id";
                    break;
                case "BSTB":
                    ...
                    sql = "UPDATE billing_status_bill SET description=@description WHERE id=@id";
                    break;
                default:
                    break;
            }
