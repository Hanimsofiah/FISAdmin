...
{
    public class SubaccSumberController : Controller
    {
        private readonly IConfiguration config;
        public List<SubaccModel> result = new List<SubaccModel>();
        public string type = "Subaccount Sumber";

        public SubaccSumberController(IConfiguration configuration)
        {
        ...
        public IActionResult Index()
        {
            ...
            {
                string sql = "SELECT kod,tajuk,CreatedBy,LastModifiedBy,CreatedDate,LastModifiedDate FROM subaccount_sumber";
        ...
        public IActionResult Create(SubaccModel obj)
        {
            ...
            if (obj.Kod.ToString() == obj.Tajuk.ToString())
            {
                ...
                TempData["error"] = "Subaccount Sumber cannot be created";
            }
            else
            {
                ...
                using (SqlConnection con = new SqlConnection(config.GetConnectionString("dbfis")))
                {
                    string sql = "SELECT kod FROM subaccount_sumber WHERE kod=@kod";
                    SqlCommand cmd = new SqlCommand(sql, con);
                    ...
                    else
                    {
                        ...
                        using (SqlConnection con2 = new SqlConnection(config.GetConnectionString("dbfis")))
                        {
                            ...
                            string sql2 = "INSERT INTO subaccount_sumber (kod,tajuk,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES (@kod,@tajuk,@CreatedBy,@CreatedDate,@LastModifiedBy,@LastModifiedDate)";
                            ...
                            TempData["success"] = "Subaccount Sumber created successfully";
        ...
        public IActionResult Edit(string id)
        {
            ...
            using (SqlConnection con = new SqlConnection(config.GetConnectionString("dbfis")))
            {
                string sql = "SELECT kod,tajuk,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate FROM subaccount_sumber WHERE kod=@kod";
                SqlCommand cmd = new SqlCommand(sql, con);
        ...
        public IActionResult Edit()
        {
            ...
            else
            {
                using (SqlConnection con = new SqlConnection(config.GetConnectionString("dbfis")))
                {
                    string sql = "UPDATE subaccount_sumber SET tajuk=@tajuk,LastModifiedBy=@LastModifiedBy,LastModifiedDate=@LastModifiedDate WHERE kod=@kod";
                    ...
                    cmd.ExecuteNonQuery();
                    TempData["success"] = "Subaccount Sumber updated successfully";
                    return RedirectToAction(nameof(Index));
        ...
        public IActionResult Delete()
        {
            using (SqlConnection con = new SqlConnection(config.GetConnectionString("dbfis")))
            {
                string sql = "DELETE FROM subaccount_sumber WHERE kod=@kod";
            ...
            TempData["success"] = "Subaccount Sumber deleted successfully";
            ViewData["type"] = type;
