...
{
    public class SubaccAktivitiController : Controller
    {
        private readonly IConfiguration config;
        public List<SubaccModel> result = new List<SubaccModel>();
        public string type = "Subaccount Aktiviti";

        public SubaccAktivitiController(IConfiguration configuration)
        {
        ...
        public IActionResult Create(SubaccModel obj)
        {
            ...
            if (obj.Kod.ToString() == obj.Tajuk.ToString())
            {
                ...
                TempData["error"] = "Subaccount Aktiviti cannot be created";
            }
            else
            {
                ...
                using (SqlConnection con = new SqlConnection(config.GetConnectionString("dbfis")))
                {
                    string sql = "SELECT kod FROM subaccount_aktiviti WHERE kod=@kod";
                    SqlCommand cmd = new SqlCommand(sql, con);
                    ...
                    else
                    {
                        ...
                        using (SqlConnection con2 = new SqlConnection(config.GetConnectionString("dbfis")))
                        {
                            ...
                            string sql2 = "INSERT INTO subaccount_aktiviti (kod,tajuk,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES (@kod,@tajuk,@CreatedBy,@CreatedDate,@LastModifiedBy,@LastModifiedDate)";
                            ...
                            TempData["success"] = "Subaccount Aktiviti created successfully";
        ...
        public IActionResult Edit(string id)
        {
            ...
            using (SqlConnection con = new SqlConnection(config.GetConnectionString("dbfis")))
            {
                string sql = "SELECT kod,tajuk,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate FROM subaccount_aktiviti WHERE kod=@kod";
                SqlCommand cmd = new SqlCommand(sql, con);
        ...
        public IActionResult Edit()
        {
            ...
            { 
                using (SqlConnection con = new SqlConnection(config.GetConnectionString("dbfis")))
                {
                    string sql = "UPDATE subaccount_aktiviti SET tajuk=@tajuk,LastModifiedBy=@LastModifiedBy,LastModifiedDate=@LastModifiedDate WHERE kod=@kod";
                    ...
                    cmd.ExecuteNonQuery();
                    TempData["success"] = "Subaccount Aktiviti updated successfully";
                    return RedirectToAction(nameof(Index));
        ...
        public IActionResult Delete()
        {
            using (SqlConnection con = new SqlConnection(config.GetConnectionString("dbfis")))
            {
                string sql = "DELETE FROM subaccount_aktiviti WHERE kod=@kod";
            ...
            TempData["success"] = "Subaccount Aktiviti deleted successfully";
            ViewData["type"] = type;
